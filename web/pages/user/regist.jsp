...
<head>
	...
	<script type="text/javascript">
        ...
        $(function () {
			...
			var allowRegist = [false,false,false,false,false];
			...
			$("#confirmedPassWord").blur(function (){
				...
				//1 获取确认密码内容
				var passwordText = $("#password").val();
				var repwdText = $("#confirmedPassWord").val();
				//2 和密码相比较
            ...
            $("#sub_btn").click(function () {
				var flag = true;
				for(var i = 0; i < allowRegist.length; i++){
					console.log(allowRegist[i]);
					if(allowRegist[i] == false){
						flag = false;
						switch (i){
							case 0:
								$("span.errorMsg").text("用户名不合法！");
			...
			<div class="login_box">
				...
				<div class="form">
					<form action="userServlet" method="post">
						<input type="hidden" name="action" value="ajaxRegist">
						<label>用户名称：</label>
						...
						<input class="itxt" type="password" placeholder="确认密码"
							   autocomplete="off" tabindex="1" name="confirmedPassWord"
